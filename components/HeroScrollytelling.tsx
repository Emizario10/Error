  ...
  return (
    <group>
      <mesh ref={p1}>
        ...
        {/* Dynamic color syncing with Zustand/CSS Variable */}
        <MeshDistortMaterial 
          color={color} 
          speed={2} 
          distort={0.2} 
    ...
    <section id="hero-main-container" className="relative w-full h-screen bg-black flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <Canvas dpr={[1, 2]}>
          ...
          <pointLight position={[5, 5, 5]} color="white" intensity={150} />
      ...
      <div ref={overlayRef} className="relative z-10 flex flex-col items-center text-center pointer-events-none px-4">
        <span className="text-tactical font-mono text-[10px] tracking-[1.5em] opacity-40 uppercase mb-8 block animate-pulse">
